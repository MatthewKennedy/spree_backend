  ...
  describe "#destroy" do
    ...
    context "will successfully destroy product" do
      ...
      describe "response" do
        ...
        it { expect(flash[:success]).to eq(I18n.t("spree.notice_messages.product_deleted")) }
      end
    end
    ...
    context "will not successfully destroy product" do
      ...
      describe "response" do
        ...
        it "set flash error" do
          expected_error = I18n.t("spree.notice_messages.product_not_deleted", error: error_msg)
  ...
  describe "#clone" do
    ...
    context "will successfully clone product" do
      ...
      describe "response" do
        ...
        it { expect(flash[:success]).to eq(I18n.t("spree.notice_messages.product_cloned")) }
      end
    end
    ...
    context "will not successfully clone product" do
      ...
      describe "response" do
        ...
        it "set flash error" do
          expected_error = I18n.t("spree.notice_messages.product_not_cloned", error: "Validation failed: Sku has already been taken")
          expect(flash[:error]).to eq(expected_error)
        end
      end
    end
