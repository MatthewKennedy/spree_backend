...
describe "Stores dash", type: :feature do
  stub_authorization!
  ...
  describe "creating store" do
    context "setting default values", js: true do
      it "sets default currency value" do
        visit spree.new_dash_store_path
    ...
    it "saving store" do
      ...
      expect(page).to have_current_path spree.dash_path
  ...
  describe "updating store", js: true do
    it do
      visit spree.edit_dash_store_path(store)
  ...
  describe "deleting store", js: true do
    ...
    it "deletes store" do
      visit spree.edit_dash_store_path(second_store)
