...
describe "Products", type: :feature do
  ...
  context "as dash user" do
    ...
    context "listing products" do
      context "sorting" do
        ...
        it "lists existing products with correct sorting by name" do
          ...
          # Name DESC
          click_link "dash_products_listing_name_title"
        ...
        it "lists existing products with correct sorting by price" do
          ...
          # Price DESC
          click_link "dash_products_listing_price_title"
          within_row(1) { expect(page).to have_content("zomg shirt") }
          within_row(2) { expect(page).to have_content("apache baseball cap") }
        end
    ...
    context "creating a new product from a prototype", js: true do
      ...
      it "allows an dash to create a new product and variants from a prototype" do
    ...
    context "creating a new product" do
      ...
      it "allows an dash to create a new product" do
      ...
      context "using a locale with a different decimal format " do
        before do
          ...
          I18n.dash.store_translations(:en,
            number: {
              currency: {
                format: {
                  separator: ",",
    ...
    context "cloning a product", js: true do
      it "allows an dash to clone a product" do
      ...
      context "cloning a deleted product" do
        it "allows an dash to clone a deleted product" do
    ...
    context "updating a product" do
      ...
      it "redirects to edit product page" do
        ...
        expect(page).to have_current_path(spree.edit_dash_product_path(product))
      end

      context "using a locale with a different decimal format" do
        before do
          # change English locale's separator and delimiter to match 19,99 format
          I18n.dash.store_translations(
            :en,
            number: {
              currency: {
                format: {
      ...
      context "with limited permissions" do
        ...
        it "As a Vendor Owner/Member I cannot change the Product state, this is reserved only to marketplace owner (spree dash)" do
          visit spree.dash_product_path(product)
    ...
    context "editing product compare at price", js: true do
      ...
      it "lets dash edit compare at price for product" do
        visit spree.dash_products_path
  ...
  context "with only product permissions" do
    ...
    custom_authorization! do |_user|
      can [:dash, :update, :read], Spree::Product
    end
    let!(:product) { create(:product, stores: Spree::Store.all) }
