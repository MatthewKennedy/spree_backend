...
describe "Return Authorizations", type: :feature do
  ...
  describe "listing" do
    ...
    it "displays state" do
      return_authorization_state = I18n.t("spree.return_authorization_states.#{return_authorization.state}")
  ...
  describe "searching" do
    ...
    it "searches on status" do
      click_on "Filters"
      select I18n.t("spree.return_authorization_states.#{return_authorization.state}"), from: "Status"
      click_on "Search"
      ...
      click_on "Filters"
      select I18n.t("spree.return_authorization_states.#{return_authorization_2.state}"), from: "Status"
      click_on "Search"
