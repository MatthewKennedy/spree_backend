...
SpreeDash.routes.apply_coupon_code = function (orderId) {
  return SpreeDash.pathFor("api/v2/platform/orders/" + orderId + "/apply_coupon_code")
}

// API v2
SpreeDash.routes.countries_api_v2 = SpreeDash.pathFor("api/v2/platform/countries")
SpreeDash.routes.classifications_api_v2 = SpreeDash.pathFor("api/v2/platform/classifications")
SpreeDash.routes.line_items_api_v2 = SpreeDash.pathFor("api/v2/platform/line_items")
...
SpreeDash.routes.payments_api_v2 = SpreeDash.pathFor("/api/v2/platform/payments")
SpreeDash.routes.products_api_v2 = SpreeDash.pathFor("/api/v2/platform/products")
SpreeDash.routes.sections_api_v2 = SpreeDash.pathFor("/api/v2/platform/cms_sections")
SpreeDash.routes.shipments_api_v2 = SpreeDash.pathFor("/api/v2/platform/shipments")
SpreeDash.routes.stock_items_api_v2 = SpreeDash.pathFor("/api/v2/platform/stock_items")
SpreeDash.routes.stock_locations_api_v2 = SpreeDash.pathFor("/api/v2/platform/stock_locations")
