  ...
  module Dash
    module SortableTreeHelper
      def sortable_tree_bar(parent_resource, child_resource)
        ...
        render "spree/dash/shared/sortable_tree/#{partial_name}", parent_resource: parent_resource, child_resource: child_resource
      end
      ...
      def build_sortable_tree(parent_resource, child_resource)
        ...
        content_tag(:div, row + container,
          ...
          data: {
            ...
            sortable_tree_update_url_value: "/dash/#{parent_resource_name.pluralize}/#{parent_resource.id}/#{child_resource_name.pluralize}/#{child_resource.id}/reposition"
          })
      end
    end
  end
