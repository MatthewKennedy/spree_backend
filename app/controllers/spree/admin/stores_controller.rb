    ...
    class StoresController < Spree::Admin::BaseController
      ...
      def create
        ...
        if @store.save
          ...
          flash[:error] = "#{I18n.t("spree.store_errors.unable_to_create")}: #{@store.errors.full_messages.join(", ")}"
      ...
      def update
        ...
        if @store.save
          ...
          flash[:error] = "#{I18n.t("spree.store_errors.unable_to_update")}: #{@store.errors.full_messages.join(", ")}"
        end
      ...
      def destroy
        ...
        if @store.destroy
          ...
          render plain: "#{I18n.t("spree.store_errors.unable_to_delete")}: #{@store.errors.full_messages.join(", ")}", status: :unprocessable_entity
        end
      end
