    ...
    class StoreCreditsController < Spree::Admin::BaseController
      ...
      def create
        ...
        if @store_credit.save
          ...
          load_categories
          flash[:error] = I18n.t("spree.store_credit.errors.unable_to_create")
      ...
      def update
        ...
        if @store_credit.save
          ...
          load_categories
          flash[:error] = I18n.t("spree.store_credit.errors.unable_to_update")
      ...
      def destroy
        ...
        if @store_credit.destroy
          ...
          render plain: I18n.t("spree.store_credit.errors.unable_to_delete"), status: :unprocessable_entity
        end
      end
      ...
      def ensure_unused_store_credit
        unless @store_credit.amount_used.zero?
          raise StoreCreditError, I18n.t("spree.store_credit.errors.cannot_change_used_store_credit")
        end
      end
    end
  end
