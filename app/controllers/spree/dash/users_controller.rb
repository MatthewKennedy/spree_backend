module Spree
  module Dash
    class UsersController < ResourceController
      ...
      def show
        redirect_to spree.edit_dash_user_path(@user)
      end
      ...
      def addresses
        if request.put?
          ...
          if @user.update(user_params)
            ...
            redirect_to spree.addresses_dash_user_path(@user)
          else
      ...
      def collection
        ...
        @collection = @search.result.page(params[:page]).per(Spree::Dash::Config[:dash_users_per_page])
      end
      ...
      # handling raise from Spree::Dash::ResourceController#destroy
