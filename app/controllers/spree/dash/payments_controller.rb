module Spree
  module Dash
    class PaymentsController < Spree::Dash::BaseController
      ...
      def create
        ...
        begin
          ...
          redirect_to new_dash_order_payment_path(@order)
        end
      end
      ...
      def fire
        ...
        redirect_to spree.dash_order_payments_path(@order)
      end
      ...
      def load_data
        ...
        @payment_methods = @order.collect_dash_payment_methods
