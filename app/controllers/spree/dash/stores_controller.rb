module Spree
  module Dash
    class StoresController < Spree::Dash::BaseController
      ...
      def create
        ...
        if @store.save
          ...
          redirect_to spree.dash_url(domain: @store.url), allow_other_host: true
        else
      ...
      def update
        ...
        redirect_to spree.edit_dash_store_path(@store)
      end
      ...
      def destroy
        ...
        if @store.destroy
          ...
          redirect_to spree.dash_url(domain: Spree::Store.default.url), allow_other_host: true
        else
