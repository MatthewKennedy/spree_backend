module Spree
  module Dash
    class ProductsController < ResourceController
      include Spree::Dash::ProductConcern

      helper "spree/dash/products"
      ...
      def add_stock
        ...
        if @stock_locations.empty?
          ...
          redirect_to spree.dash_stock_locations_path
        end
      end
      ...
      def remove_from_taxon
        ...
        if @object.taxons.delete(@taxon)
          respond_to do |format|
            format.turbo_stream { render "spree/dash/taxons/remove_from_taxon" }
          end
        else
      ...
      def location_after_save
        spree.edit_dash_product_path(@product)
      end
      ...
      def collection
        ...
        @collection = @search.result
          ...
          .page(params[:page])
          .per(params[:per_page] || Spree::Dash::Config[:dash_products_per_page])
