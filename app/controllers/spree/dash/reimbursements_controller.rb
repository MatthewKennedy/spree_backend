    ...
    class ReimbursementsController < ResourceController
      ...
      def location_after_save
        if @reimbursement.reimbursed?
          spree.dash_order_reimbursement_path(parent, @reimbursement)
        else
          spree.edit_dash_order_reimbursement_path(parent, @reimbursement)
        end
      end
      ...
      def spree_core_gateway_error(error)
        ...
        redirect_to spree.edit_dash_order_reimbursement_path(parent, @reimbursement)
      end
    end
  end
end
